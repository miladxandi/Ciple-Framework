...
set(asio_INCLUDE_DIRS ${asio_INCLUDE_DIRS_MINSIZEREL} )
set(asio_INCLUDE_DIR ${asio_INCLUDE_DIRS_MINSIZEREL} )
set(asio_LIBRARIES ${asio_LIBRARIES_MINSIZEREL} )
set(asio_DEFINITIONS ${asio_DEFINITIONS_MINSIZEREL} )


# Only the last installed configuration BUILD_MODULES are included to avoid the collision
foreach(_BUILD_MODULE ${asio_BUILD_MODULES_PATHS_MINSIZEREL} )
